...
const projects = [
	{
		name: "IITIbot",
		desc: "Multi-agent RAG chatbot able to answer complex queries about IIT Indore, leveraging advanced retrieval techniques for accurate and context-aware responses.",
