    ...
    <section className="relative h-screen w-full overflow-hidden flex flex-col justify-center items-center text-center px-4">
      ...
      >
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 mb-6 rounded-full bg-white/70 dark:bg-zinc-900/60 backdrop-blur-md border border-zinc-200/80 dark:border-white/10 shadow-sm text-xs sm:text-sm font-sans font-medium text-zinc-800 dark:text-zinc-200"
        >
          <span className="relative flex h-2 w-2">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
            <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
          </span>
          <span>Incoming Developer Intern @ <span className="text-indigo-600 dark:text-indigo-400 font-semibold">Samsung R&D (SRIB)</span></span>
        </motion.div>
