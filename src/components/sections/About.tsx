export default function About() {
  return (
      <section id="about" className="py-32 px-6 max-w-3xl text-center">
        <h2 className="text-6xl font-serif font-medium mb-6 translate-y-6">About Me</h2>
        <p className="text-lg text-zinc-600 font-sans dark:text-zinc-400 translate-y-6">
